...
void SWLSet(byte mask);           // Returns current state of PT1AD1
void SWLClear(byte mask);         // Returns current state of PT1AD1
void SWLToggle(byte mask);        // Returns current state of PT1AD1
